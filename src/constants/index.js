...
export const projects = [
  {
    ...
    name: "Mon Portfolio",
    description:
      "Création d'un portfolio de développement web qui présente des projets variés, incluant des applications interactives, des sites responsives et des outils innovants, démontrant mes compétences en HTML, CSS, JavaScript, et autres technologies web.",
  ...
  },
  {
    ...
    name: "Open souls",
    description:
      "Développement d'un jeu au tour par tour en React, utilisant des appels API et inspiré de l'univers de Dark Souls. Le projet met en avant le choix du joueur, des mécaniques de combat stratégiques et l'intégration de données dynamiques provenant d'API pour enrichir l'expérience de jeu.",
